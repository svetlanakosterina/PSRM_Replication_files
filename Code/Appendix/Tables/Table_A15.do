...
* 2 interactions:
	* all areas, 30km:
logit vote_npp_pres akan_30km_l_p careful_o c.akan_30km_l_p#c.careful_o road_af c.akan_30km_l_p#c.road_af eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb , robust cluster(fid0725) 
	* all areas, 5km:
logit vote_npp_pres akan_5km_l_p careful_o c.akan_5km_l_p#c.careful_o road_af c.akan_5km_l_p#c.road_af eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb , robust cluster(fid0725) 
