...
* 2 interactions:
	* all areas, 30km:
logit vote_npp_pres akan_30km_l_p careful_o c.akan_30km_l_p#c.careful_o health_clinic_af c.akan_30km_l_p#c.health_clinic_af eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb , robust cluster(fid0725) 
	* all areas, 5km:
logit vote_npp_pres akan_5km_l_p careful_o c.akan_5km_l_p#c.careful_o health_clinic_af c.akan_5km_l_p#c.health_clinic_af eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb , robust cluster(fid0725) 
