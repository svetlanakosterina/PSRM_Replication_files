...
logit vote_npp_pres akan_30km_l_p polcare c.akan_30km_l_p#c.polcare eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb if eth_akan == 0 , robust cluster(fid0725) 
logit vote_npp_pres akan_5km_l_p polcare c.akan_5km_l_p#c.polcare eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb if eth_akan == 0 , robust cluster(fid0725) 
logit vote_npp_pres akan_30km_l_p polcare c.akan_30km_l_p#c.polcare eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb if eth_akan == 1 , robust cluster(fid0725) 
logit vote_npp_pres akan_5km_l_p polcare c.akan_5km_l_p#c.polcare eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb if eth_akan == 1 , robust cluster(fid0725) 
