...
*------------------------------------------------------------------------------
* Factor Analysis: Intimidation and careful_o
*------------------------------------------------------------------------------
...
*------------------------------------------------------------------------------
	* all areas, 30km:
logit vote_npp_pres akan_30km_l_p polcare c.akan_30km_l_p#c.polcare eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central urb , robust cluster(fid0725) 
	* rural areas, 30km:
logit vote_npp_pres akan_30km_l_p polcare c.akan_30km_l_p#c.polcare eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 central if urb==0 , robust cluster(fid0725) 
	* urban areas, 30km:
logit vote_npp_pres akan_30km_l_p polcare c.akan_30km_l_p#c.polcare eth_akan eth_ewe eth_dagomba male economy_oneyear poverty dev_factor2 if urb==1 , robust cluster(fid0725) 
